...
namespace Infrastructure.ECS
{
    ...
    namespace Scellecs.EcsStartup
    {
		...
		{ 
            ...
            {
                buildSetupInOrder += () => { feature.Configure(new FeatureBuilder(this, order)); };
            }
            ...
            public readonly struct FeatureBuilder
            {
                ...
                public FeatureBuilder AddFeatureInjected<T>() where T : class, IEcsFeature
                {
                    ecsStartup.AddSystemsGroup().AddFeatureInjected<T>();
                    return this;
                }
#endif
